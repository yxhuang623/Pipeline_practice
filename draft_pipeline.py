...
# Create path to your original ref file and ref path which will be generated by this pipeline
os.system("cd YXpipeline")
# Before running this pipeline, you must create a new directionary named "reference_file"  
