...
referencepath = "~/YXpipeline/reference/P125109.fasta"
# Create index file for reference
os.system("bwa index " + referencepath)

# Alignment using BWA
# i = 1
sampleDirectories = "~/YXpipeline/output_files/sampleDirectories.txt"
SD_file = open(sampleDirectories, 'w')
for sample_folder in os.listdir("~/YXpipeline/samples"):
    print(sample_folder)
    fastqpath = []
    sample_folderpath = "~/YXpipeline/samples/" + sample_folder.__str__()
...
remarkedoutput_file = open("~/YXpipeline/output_files/" + filteredsnplist, 'w')
snplistfile = open("~/YXpipeline/output_files/snplist.txt", 'r')
...
fsnplistfile = codecs.open("~/YXpipeline/output_files/filteredsnplist.txt", 'r')
snpsitsnumber = []
...
for sample_folder in os.listdir("~/YXpipeline/samples"):
    sample_folderpath = "~/YXpipeline/samples/" + sample_folder
    print(sample_folderpath)
    snpma_output_file = "~/YXpipeline/output_files/snpmatrix.fasta"
